...
func (_c *Repository_FindByID_Call) Return(_a0 *entity.Room, _a1 error) *Repository_FindByID_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Repository_FindByID_Call) RunAndReturn(run func(context.Context, int64) (*entity.Room, error)) *Repository_FindByID_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *Repository_Save_Call) Run(run func(ctx context.Context, _a1 *entity.Room)) *Repository_Save_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *Repository_Save_Call) RunAndReturn(run func(context.Context, *entity.Room) error) *Repository_Save_Call {
	_c.Call.Return(run)
	return _c
}
