...
func TestSanitizeHeaders(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "qiscus-secret-key header",
			headers: http.Header{
				"Qiscus-Secret-Key": []string{"secret123"},
				"Qiscus-App-Id":     []string{"app123"},
			},
			expected: map[string]string{
				"Qiscus-Secret-Key": RedactedValue,
				"Qiscus-App-Id":     "app123",
			},
		},
		{
